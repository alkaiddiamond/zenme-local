...
contextBridge.exposeInMainWorld("zenmeDesktop", {
  ...
  getMusicServiceConfiguration: () => ipcRenderer.invoke("zenme:get-music-service-configuration"),
  getMusicServiceStatus: () => ipcRenderer.invoke("zenme:get-music-service-status"),
  configureMusicServiceApi: (input) => ipcRenderer.invoke("zenme:configure-music-service-api", input),
  clearMusicServiceApiConfiguration: () => ipcRenderer.invoke("zenme:clear-music-service-api-configuration"),
